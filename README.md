...
* При срабатывании кнопки или датчика движения экран автоматически повышает яркость (показывает время) или делает заданное запрограммированное действие.
...
* Можно скачать обновление или контент для отображения на матрице с сервера.

### Настройка
* Настройка выполняется через веб-клиент или Android-приложение. Простые настройки можно сделать на самой матрице.
...
- Обработка кнопок, датчиков (например, движения), обработка api запросов, обращение в интернет, работа с sd картой, работа со светодиодной матрицей
...
- Интерпретация пользовательских скриптов на lua
- Другие идеи
